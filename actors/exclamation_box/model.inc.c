...
static const Vtx exclamation_box_seg8_vertex_08018E28[] = {
    {{{   -25,     -25,    -25}, 0, {   992,    992}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   -25,     26,    -25}, 0, {   992,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{    26,     26,    -25}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   -25,     -25,     26}, 0, {     0,    992}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{    26,     -25,     26}, 0, {   992,    992}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{    26,     26,     26}, 0, {   992,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -25,     26,     26}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{    26,     26,    -25}, 0, {   992,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{    26,     -25,     26}, 0, {     0,    992}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{    26,     -25,    -25}, 0, {   992,    992}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{    26,     26,     26}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   -25,     -25,    -25}, 0, {     0,    992}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -25,     -25,     26}, 0, {   992,    992}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -25,     26,     26}, 0, {   992,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   -25,     26,    -25}, 0, {     0,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{    26,     -25,    -25}, 0, {     0,    992}, {0x00, 0x00, 0x81, 0xff}}},
};

// 0x08018F28
static const Vtx exclamation_box_seg8_vertex_08018F28[] = {
    {{{    26,     -25,    -25}, 0, {   992,   2014}, {0x00, 0x81, 0x00, 0xff}}},
    {{{    26,     -25,     26}, 0, {   992,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -25,     -25,     26}, 0, {     0,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -25,     -25,    -25}, 0, {     0,   2014}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -25,     26,    -25}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -25,     26,     26}, 0, {     0,   2014}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    26,     26,     26}, 0, {   992,   2014}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    26,     26,    -25}, 0, {   992,      0}, {0x00, 0x7f, 0x00, 0xff}}},
};
...
static const Vtx exclamation_box_seg8_vertex_080191A0[] = {
    {{{   -25,     26,     26}, 0, {     0,    992}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    26,     26,     26}, 0, {  2014,    992}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    26,     26,    -25}, 0, {  2014,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -25,     26,    -25}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -25,     -25,     26}, 0, {     0,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   -25,     -25,    -25}, 0, {     0,    992}, {0x00, 0x81, 0x00, 0xff}}},
    {{{    26,     -25,    -25}, 0, {  2014,    992}, {0x00, 0x81, 0x00, 0xff}}},
    {{{    26,     -25,     26}, 0, {  2014,      0}, {0x00, 0x81, 0x00, 0xff}}},
};
