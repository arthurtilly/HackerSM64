...
static const Vtx wooden_signpost_seg3_vertex_0302C958[] = {
    {{{     0,    504-252,     19-16}, 0, {   962,    478}, {0x00, 0x7e, 0xfc, 0xff}}},
    {{{    24,    490-252,     34-16}, 0, {   938,    780}, {0x62, 0x3b, 0x36, 0xff}}},
    {{{     0,    490-252,     -6-16}, 0, {   938,    478}, {0xff, 0x39, 0x90, 0xff}}},
    {{{   -23,    490-252,     34-16}, 0, {   938,    178}, {0x9e, 0x3a, 0x36, 0xff}}},
    {{{     0,    -39-252,     34-16}, 0, {    36,    478}, {0x00, 0xfc, 0x7e, 0xff}}},
    {{{   -23,    -39-252,     -6-16}, 0, {    36,    178}, {0x93, 0x00, 0xc1, 0xff}}},
    {{{    24,    -39-252,     -6-16}, 0, {    36,    780}, {0x6d, 0x00, 0xc0, 0xff}}},
};
...
static const Vtx wooden_signpost_seg3_vertex_0302DAC0[] = {
    {{{   180,    260-252,     20-16}, 0, {   990,    990}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  -179,    260-252,     60-16}, 0, {     0,    990}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  -179,    260-252,     20-16}, 0, {     0,    990}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   180,    260-252,     20-16}, 0, {   990,    990}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -179,    260-252,     20-16}, 0, {     0,    990}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -179,    460-252,     20-16}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -179,    260-252,     20-16}, 0, {     0,    990}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -179,    260-252,     60-16}, 0, {     0,    990}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -179,    460-252,     60-16}, 0, {     0,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -179,    460-252,     20-16}, 0, {     0,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   180,    260-252,     60-16}, 0, {   990,    990}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  -179,    460-252,     20-16}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -179,    460-252,     60-16}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   180,    460-252,     60-16}, 0, {   990,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   180,    460-252,     20-16}, 0, {   990,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   180,    460-252,     20-16}, 0, {   990,      0}, {0x00, 0x7f, 0x00, 0xff}}},
};

// 0x0302DBC0
static const Vtx wooden_signpost_seg3_vertex_0302DBC0[] = {
    {{{   180,    260-252,     60-16}, 0, {   990,    990}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   180,    460-252,     20-16}, 0, {   990,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   180,    460-252,     60-16}, 0, {   990,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   180,    260-252,     20-16}, 0, {   990,    990}, {0x7f, 0x00, 0x00, 0xff}}},
};

// 0x0302DC00
static const Vtx wooden_signpost_seg3_vertex_0302DC00[] = {
    {{{  -179,    260-252,     60-16}, 0, {     0,    990}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   180,    460-252,     60-16}, 0, {   990,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -179,    460-252,     60-16}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   180,    260-252,     60-16}, 0, {   990,    990}, {0x00, 0x00, 0x7f, 0xff}}},
};
